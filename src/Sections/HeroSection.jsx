export const HeroSection = ({
  ...
  return (
    <div className={`${height? height:`min-h-dvh`} bg-cover bg-center`} style={{ backgroundImage: `url(${bgLink})` }}>
      <div className={`w-full ${height? height:`min-h-dvh`} bg-black/80 flex justify-center items-center`}>
